...
const productAPI: string = 'http://localhost:3000/product';

async function getctProduct(id: string, callback: (product: Product) => void): Promise<void> {
    try {
...
window.onload = function() {
    ...
    if (productId) {
        getctProduct(productId, (product: Product) => {
            
            if (product) {
                const showctsp = document.getElementById("showct") as HTMLElement;
                showctsp.innerHTML = `
                <div class="col-md-5">
        ...
        <div class="col-md-7">
            <div class="box_content-sp">
                ...
                `;
                const showmtsp = document.getElementById("showmt") as HTMLElement;
                showmtsp.innerHTML = `
